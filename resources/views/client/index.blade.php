        ...
        <div class="container relative md:mt-24 mt-16">
            ...
            <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-2 pt-6 gap-6">
                <x-splade-lazy>
                    <x-slot:placeholder>
                        <div class="grid grid-cols-1 justify-center text-center mb-6">
                            <p class="text-slate-400 max-w-xl mx-auto"> The items are loading... </p>
                        </div>
                    </x-slot:placeholder>
                    @foreach ($products as $product)
                        <div class="group">
                            <div
                                ...
                                <img src="{{ 'https://loremflickr.com/500/650' ?? asset('../resources/assets/images/shop/500x650.png') }}"
                                    alt="Product Image" class="group-hover:scale-110 duration-500">
