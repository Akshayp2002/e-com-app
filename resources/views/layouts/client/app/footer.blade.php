                        ...
                        <form>
                            <div class="grid grid-cols-1">
                                ...
                                <button type="submit" id="submitsubscribe" name="send"
                                    class="py-2 px-5 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-orange-500 text-white rounded-md">Subscribe</button>
                            </div>
                        </form>
                    </div><!--end col-->
                </div><!--end grid-->
        ...
        <div class="grid md:grid-cols-2 items-center">
            ...
            <ul class="list-none md:text-end text-center mt-6 md:mt-0">
                <li class="inline"><a href=""><img
                            src="{{ asset('../resources/assets/images/payments/american-express.jpg') }}"
                            class="max-h-6 rounded inline" title="American Express" alt=""></a></li>
                <li class="inline"><a href=""><img
                            src="{{ asset('../resources/assets/images/payments/discover.jpg') }}"
                            class="max-h-6 rounded inline" title="Discover" alt=""></a></li>
                <li class="inline"><a href=""><img
                            src="{{ asset('../resources/assets/images/payments/mastercard.jpg') }}"
                            class="max-h-6 rounded inline" title="Master Card" alt=""></a></li>
                <li class="inline"><a href=""><img
                            src="{{ asset('../resources/assets/images/payments/paypal.jpg') }}"
                            class="max-h-6 rounded inline" title="Paypal" alt=""></a></li>
                <li class="inline"><a href=""><img
                            src="{{ asset('../resources/assets/images/payments/visa.jpg') }}"
                            class="max-h-6 rounded inline" title="Visa" alt=""></a></li>
            </ul>
        </div><!--end grid-->
    </div><!--end container-->
</div>
